...
require_once "classes/login_user.php";
...
<body>
  <div class="alert-container" style="display:<?php echo $alert; ?>">
<div class="alert"><center><h3><?php echo @$login->login("users_table",$user_name,$password); ?></h3></center></div>
</div>
<div class="pen-title">
